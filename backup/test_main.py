...
def resource_path(relative_path):
    ...
    except Exception as e: print(f'Exception for {symbol}: {e}')
...
class App(ctk.CTk):
    def __init__(self):
        ...
        # Treeview for Today's results
        style = ttk.Style()
        style.theme_use("default")
        style.configure("Treeview", rowheight=25)

        columns = ("Symbol", "Probability", "Current Price", "Target (7%)", "Stop Loss (3%)", "Quantity (Max 10k)")
        self.tree = ttk.Treeview(self.tab_today, columns=columns, show="headings", height=6)
        ...
        self.label_hint = ctk.CTkLabel(self.tab_today, text="Double-click a stock to see Analysis Insights")
        ...
        self.hist_tree = ttk.Treeview(self.tab_history, columns=hist_cols, show="headings", height=6)
